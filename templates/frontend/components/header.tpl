...
<div class="pkp_structure_page">
    ...
    <nav id="accessibility-nav" class="sr-only" role="navigation" aria-labelled-by="accessible-menu-label">
        ...
        <ul>
            <li>
                <a href="#main-navigation">{translate|escape key="plugins.themes.academic_free.accessible_menu.main_navigation"}</a>
            </li>
            <li>
                <a href="#main-content">{translate|escape key="plugins.themes.academic_free.accessible_menu.main_content"}</a>
            </li>
            <li><a href="#sidebar">{translate|escape key="plugins.themes.academic_free.accessible_menu.sidebar"}</a>
            </li>
        </ul>
    </nav>
